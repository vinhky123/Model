...
class EncoderLayer(nn.Module):
    ...
    def forward(self, x, x_mask=None, tau=None, delta=None):
        # Self-attention only (no cross-attention with STAR_patch)
        x = x + self.dropout(
...
class Model(nn.Module):
    """
    TimeStar without multivariate STAR_patch module
    ...
    def __init__(self, configs):
        ...
        # Encoder-only architecture (no cross-attention)
    ...
    def forecast_multi(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        # No ex_embedding needed - we don't use cross-attention
