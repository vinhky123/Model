...
import random
import numpy as np
from exp.exp_btc_classification import Exp_BTC_Classification
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="BTC Price Classification")

    # basic config
    parser.add_argument(
        "--task_name", type=str, default="btc_classification", help="task name"
    )
    ...
    # data loader
    parser.add_argument(
        "--data_path", type=str, required=True, help="path to BTC data file"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--freq", type=str, default="d", help="freq for time features encoding"
    )
    parser.add_argument(
        "--checkpoints",
        type=str,
    ...
    parser.add_argument(
        "--channel_independence", type=int, default=1, help="channel independence"
    )
    ...
    Exp = Exp_BTC_Classification

    if args.is_training:
        for ii in range(args.itr):
            # setting record of experiments
            setting = "{}_{}_{}_ft{}_sl{}_pl{}_lr{}_bs{}_hid{}_s{}_l{}_dp{}_eb{}_dt{}_{}_{}".format(
                args.task_name,
                args.model_id,
                args.model,
                args.features,
